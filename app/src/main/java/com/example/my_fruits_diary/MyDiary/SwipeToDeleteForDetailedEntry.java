...
public class SwipeToDeleteForDetailedEntry extends ItemTouchHelper.SimpleCallback {
        private RecyclerViewAdapterForDetailedEntry mAdapter;
        private Drawable icon;
        private ColorDrawable background;
        private Context mContext;

    public SwipeToDeleteForDetailedEntry(RecyclerViewAdapterForDetailedEntry adapter, Context context) {
